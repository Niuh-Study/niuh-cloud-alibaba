    ...
    public Server choose(Object key) {
        try {
            ...
            if(theSameClusterNameInstList.isEmpty()) {
                ...
                toBeChooseInstance = NiuhWeightedBalancer.chooseInstanceByRandomWeight(allInstance);
                ...
                toBeChooseInstance = NiuhWeightedBalancer.chooseInstanceByRandomWeight(theSameClusterNameInstList);

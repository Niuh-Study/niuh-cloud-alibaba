package com.niuh.config.inmemory;
...
public class NiuhAuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.inMemory()
                ...
                .and()
                    ...
                    .secret(passwordEncoder.encode("hejianhui"))

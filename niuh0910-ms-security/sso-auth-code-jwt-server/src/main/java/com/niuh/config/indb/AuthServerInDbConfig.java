...
import com.niuh.config.NiuhUserDetailService;
...
public class AuthServerInDbConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private NiuhUserDetailService userDetailsService;
     ...
     */
    @Bean
    public NiuhTokenEnhancer niuhTokenEnhancer() {
        return new NiuhTokenEnhancer();
    }
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        tokenEnhancerChain.setTokenEnhancers(Arrays.asList(niuhTokenEnhancer(),jwtAccessTokenConverter()));
